                            ...
                            for breakfast_servings in range(1, int(breakfast[5]) + 1):  # Assuming servings is an integer
                                for lunch_servings in range(1, int(lunch[5]) + 1):
                                    for dinner_servings in range(1, int(dinner[5]) + 1):
                                        ...
                                        current_combination1 = tuple([breakfast[6], lunch[6], breakfast_servings, lunch_servings])
                                        current_combination2 = tuple([breakfast[6], dinner[6], breakfast_servings, dinner_servings])
                                        current_combination3 = tuple([dinner[6], breakfast[6], dinner_servings, breakfast_servings])
                                        current_combination4 = tuple([dinner[6], lunch[6], dinner_servings, lunch_servings])
                                        current_combination5 = tuple([lunch[6], breakfast[6], lunch_servings, breakfast_servings])
                                        current_combination6 = tuple([lunch[6],  dinner[6], lunch_servings,  dinner_servings])
